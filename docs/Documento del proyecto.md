...
------------- | ------------- | ------------- | ------------- | ------------- | ------------- |  ------------- |  ------------- | 
[Adame Mantecón, Manuel](https://github.com/ManuelAdame) | HH | XX | YY | ZZ | II | Enviar un correo electrónico de verificación cuando un nuevo usuario se registra, para confirmar que la dirección de correo electrónico es válida | L |
[Buzón Muñoz, Manuel Zoilo](https://github.com/manumnzz) | HH | XX | YY | ZZ | II | Permite comparar versiones de un dataset para identificar qué ha cambiado entre ellas | H |
[Carmona Reina, Alejandro](https://github.com/aleecar04) | HH | XX | YY | ZZ | II | Permitir cambios menores en los datasets que no impliquen cambios en los archivos ni en el contenido sustancial, siguiendo el modelo Zenodo. Estos cambios no generan un nuevo DOI, sino que actualizan el conjunto de datos existente | H |
[Granado Oliva, Samuel](https://github.com/SamuelGRA) | HH | XX | YY | ZZ | II | Limitar los intentos fallidos de inicio de sesión para evitar ataques de fuerza bruta | L |
[Lavado Corredera, Manuel](https://github.com/60Manu82) | HH | XX | YY | ZZ | II | Filtrado de los resultados de búsqueda por comunidad, para centrarse en conjuntos de datos de un tema o institución específicos | M |
[Román Jiménez, Darío](https://github.com/DarioRJ17) | HH | XX | YY | ZZ | II | Una clasificación de los datasets más vistos o descargados recientemente para descubrir qué es popular en la plataforma | M |
**TOTAL** | tHH  | tXX | tYY | tZZ | tII | Se han realizado 8 work items en total, 2 de cada dificultad. Además de los 2 work items obligatorios, fakenodo y newdataset | H(2)/M(2)/L(2) |
